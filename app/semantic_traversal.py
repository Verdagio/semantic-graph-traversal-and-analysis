...
def semantic_traversal(graph: Graph, embedding_model: EmbeddingModel, start_vertex_id: str, context: str, ignore_direction=False, min_score_threshold=0.01) -> tuple:
    """
    ...
    Args:
        ...
        min_score_threshold (float, optional): The minimum threshold for semantic scores. Defaults to 0.01.
            ...
            for neighbor, _ in graph.adjacency_list[vertex_id]: 
                if neighbor not in visited:
                    ...
                    if semantic_score >= min_score_threshold:
                        heapq.heappush(min_heap, (-semantic_score, neighbor, path))
